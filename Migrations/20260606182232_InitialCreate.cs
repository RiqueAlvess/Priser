        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyValues_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePoints = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RenewalPeriod = table.Column<string>(type: "text", nullable: false),
                    NextRenewalDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ResetUnused = table.Column<bool>(type: "boolean", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Budgets_Users_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyValueId = table.Column<Guid>(type: "uuid", nullable: true),
                    Message = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recognitions_CompanyValues_CompanyValueId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitPoints = table.Column<decimal>(type: "numeric", nullable: false),
                    TotalPoints = table.Column<decimal>(type: "numeric", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ApprovalRequests_Recognitions_RecognitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Recognitions_RecognitionId",
                        column: x => x.RecognitionId,
                        principalTable: "Recognitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "DeletedAt", "Description", "Name", "NormalizedName", "UpdatedAt" },
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(2026, 6, 6, 18, 22, 31, 625, DateTimeKind.Utc).AddTicks(4504), null, "Platform-level superuser", "SystemAdmin", "SYSTEMADMIN", null },
                    { new Guid("00000000-0000-0000-0000-000000000002"), new DateTime(2026, 6, 6, 18, 22, 31, 625, DateTimeKind.Utc).AddTicks(4515), null, "HR Admin for a tenant", "TenantAdmin", "TENANTADMIN", null },
                    { new Guid("00000000-0000-0000-0000-000000000003"), new DateTime(2026, 6, 6, 18, 22, 31, 625, DateTimeKind.Utc).AddTicks(4524), null, "Team manager", "Manager", "MANAGER", null },
                    { new Guid("00000000-0000-0000-0000-000000000004"), new DateTime(2026, 6, 6, 18, 22, 31, 625, DateTimeKind.Utc).AddTicks(4532), null, "Regular employee", "Employee", "EMPLOYEE", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalRequests_RecognitionId",
                table: "ApprovalRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_RecognitionId",
                table: "Comments",
                column: "RecognitionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyValues_TenantId",
                table: "CompanyValues",
                column: "TenantId");
